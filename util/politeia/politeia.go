...
func New(ctx context.Context, politeiaURL string, dbPath string, log util.Logger) (*Politeia, error) {
	if dbPath == "" {
	...
	dbConn := util.NewConnectionMaster(db)
