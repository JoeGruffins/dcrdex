...
import (
	...
	basenet "github.com/bisoncraft/meshwallet/util/networks/base"
...
func buildAllowedTargets(net util.Network) map[int64]map[common.Address]bool {
	m := make(map[int64]map[common.Address]bool)
	addTargets := func(chainIDs map[util.Network]int64, mainnetChainID int64, contracts map[uint32]map[util.Network]common.Address) {
