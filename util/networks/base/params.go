...
var (
	...
	ContractAddresses = map[uint32]map[util.Network]common.Address{
		...
		1: {
			util.Mainnet: common.HexToAddress("0x85c4e942AE2729a3C61275d4ff90A245c81592ae"), // tx 0x7afd0e21841fc1ba77356be3d93a0ad8bbfe1b6279a2c885b8320c8e0e74c216
			util.Testnet: common.HexToAddress("0x60bd71f644b7519BC13dA76D8E121b38ef738fCe"), // tx 0x46a314b14d9f565d1b962b3f5e9e8930c7650e307c7cf56d06705add94154595
			util.Simnet:  common.HexToAddress(""),                                           // Filled in by MaybeReadSimnetAddrs
		},
	}
...
func MaybeReadSimnetAddrs() {
	dexeth.MaybeReadSimnetAddrsDir("base", ContractAddresses, MultiBalanceAddresses, Tokens[usdcTokenID].NetTokens[util.Simnet], Tokens[usdtTokenID].NetTokens[util.Simnet])
}
