...
var (
	...
	//   init:            0xcdca4e6ad907dad5968de886065da1699c23eb69b2ad18f32c8a3053c028312d
	//   redeem:          0x5aa56484fe3a7de13bdaa7070ee9657bbf3a7ab709702cab776b747b0d32d1d1
	//   refund:          0x77e6fb75f72a6dc349b5f0c8bab57037dba1013449d49fa134e23b985885e17a
	//   gasless redeem:  0xa036c09c42872c17e929f3b75ea5f3408023c36a3f65be81c9e5267bba62a36a
	v1Gases = &dexeth.Gases{
		// Mainnet measurements:
		// Swaps (n=1..5):   [54317 84069 113821 143574 173328]
		Swap:    70_612,
		SwapAdd: 38_677,
		// Redeems (n=1..5): [44988 58430 71861 85305 98751]
		Redeem:    58_484,
		RedeemAdd: 17_472,
		// Refunds (n=1..6): [48069 48069 48069 48069 48069 42940]
		Refund: 61_378,

		// Signed redeems (n=1..5): [85292 82202 96178 110168 124173]
		...
		SignedRedeem:    110_879,
		SignedRedeemAdd: 12_636,
	}

	// tokenV1Gases are the gas estimates for v1 token swap contracts, measured
	// from usdt.polygon mainnet. These values are used for all tokens on all
	...
	ContractAddresses = map[uint32]map[util.Network]common.Address{
		0: {
			util.Mainnet: common.HexToAddress("0x74922db9f530b22d7ebea8e6920e256cf3cc0542"), // txid: 0x9ef5e128119da8e66d364b7e656758ea7232d2dfb14c8463abac1f5ac62c986f
			util.Testnet: common.HexToAddress("0x73bc803A2604b2c58B8680c3CE1b14489842EF16"), // txid: 0x88f656a8e432fdd50f33e67bdc39a66d24f663e33792bfab16b033dd2c609a99
			util.Simnet:  common.HexToAddress(""),                                           // Filled in by MaybeReadSimnetAddrs
		},
		1: {
			util.Mainnet: common.HexToAddress("0x8C4484ABb1E003e5dDE399aFbBa8B9369f45AE3D"), // tx 0xc9931ebcd19320cd5556ef82b8c4ac55943b4bdc3e904179aaa935a21627a241
			util.Testnet: common.HexToAddress("0x809AcFc7E94C047Dc2D4642BF3794f9d6CE37B8F"), // tx 0x7637643dcdafad4a261f402bbb143810bf8c60a3a7c27ef2e874fc9a25b16d5c
			util.Simnet:  common.HexToAddress(""),                                           // Filled in by MaybeReadSimnetAddrs
		},
	}

	MultiBalanceAddresses = map[util.Network]common.Address{
		util.Mainnet: common.HexToAddress("0x23d8203d8E3c839F359bcC85BFB71cf0d707EDF0"), // tx: 0xc593222106c700b153977fdf290f8d9656610cd2dd88522724e85b3f7fd600cf
		util.Testnet: common.HexToAddress("0xa958d5B8a3a29E3f5f41742Fbb939A0dd93EB418"), // tx 0x692cf15b145cb45c0098bedf8a55d067b1ac994973bb62000c046b8453d8b624
	}
	...
	TokenUSDC = &dexeth.Token{
		...
		NetTokens: map[util.Network]*dexeth.NetToken{
			util.Mainnet: {
			...
			util.Mainnet: {
				...
				SwapContracts: map[uint32]*dexeth.SwapContract{
					...
					1: {
						...
						//   approve:   0x952edd274572f22db7e7631da7cf57430a1ae1736b83350f5b7e11d600863879
						//   transfer:  0xf9bc549ac8d20b0eda780edfc6fc8223a527553483431c20855c39ce354b152f
						//   init:      0x07fae34e7a5a2cbdc3aa9de80a779db24e3b56d9a9708881fd11ae9132ddce50
						//   redeem:    0x1da1fafb0ca5ce54ae1f3b02956b86076856d04099da88c763e1e90041b16b88
						//   refund:    0x50c69a0256e45afb889521567ed8732b97d1888f96b9dc1a2ec7051fefd2f98a
						// Mainnet measurements:
						// Swaps (n=1..5):   [108864 138591 168308 198049 227767]
						// Redeems (n=1..5): [57195 70601 84008 97453 110850]
						// Refunds (n=1..6): [69160 69160 69160 69160 69160 55132]
...
func MaybeReadSimnetAddrs() {
	dexeth.MaybeReadSimnetAddrsDir("polygon", ContractAddresses, MultiBalanceAddresses, Tokens[usdcTokenID].NetTokens[util.Simnet], Tokens[usdtTokenID].NetTokens[util.Simnet])
}
