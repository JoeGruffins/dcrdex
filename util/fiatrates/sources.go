	...
	sources := []*source{
		{
			...
			getRates: func(ctx context.Context, tickers []string, _ util.Logger) (map[string]float64, error) {
		...
		},
		{
			...
			getRates: func(ctx context.Context, tickers []string, log util.Logger) (map[string]float64, error) {
