...
```bash
go build -tags xmr ./wallet/cmd/bisonw
```
...
```bash
# Linux x86_64
cp wallet/asset/xmr/lib/linux-amd64/libwallet2_api_c.so ./

# Linux ARM64
cp wallet/asset/xmr/lib/linux-arm64/libwallet2_api_c.so ./

# macOS ARM64 (Apple Silicon)
cp wallet/asset/xmr/lib/darwin-arm64/libwallet2_api_c.dylib ./
codesign -s - bisonw

# macOS x86_64 (Intel)
cp wallet/asset/xmr/lib/darwin-amd64/libwallet2_api_c.dylib ./
codesign -s - bisonw
...
sudo cp wallet/asset/xmr/lib/linux-amd64/libwallet2_api_c.so /usr/lib/bisonw/
```
...
```bash
# From the wallet/asset/xmr directory
