...
func TestScanMainnetBlocks(t *testing.T) {
	testScanBlocks(t, util.Mainnet, 415_000, 425_000, "8888")
}
...
func TestScanMainnetRecentBlocks(t *testing.T) {
	testScanBlocks(t, util.Mainnet, 900_000, 1_173_927, "8888") // 1173927 2025-09-26
}

func testScanBlocks(t *testing.T, net util.Network, startHeight, endHeight int64, port string) {
	u, _ := user.Current()
