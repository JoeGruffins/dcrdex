...
func TestRefund(t *testing.T) {
	...
	_, err = wallet.Refund(t.Context(), badContractOutput.ID(), randBytes(50), feeSuggestion)
	if err == nil {
...
func TestRedeemPrivate(t *testing.T) {
	...
	_, _, _, err = wallet.RedeemPrivate(t.Context(), invalidContract, unsignedRedeemB, adaptorSigB, adaptorSecret)
	if err == nil {
	...
	_, _, _, err = wallet.RedeemPrivate(t.Context(), invalidContract2, unsignedRedeemB, adaptorSigB, adaptorSecret)
	if err == nil {
