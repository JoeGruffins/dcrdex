...
func TestSwap(t *testing.T) {
	...
	queueSuccess()
	_, _, feesPaid, err := w.Swap(t.Context(), swaps)
	if err != nil {
...
func TestRedeem(t *testing.T) {
	...
	_, _, _, err = w.Redeem(t.Context(), redemptions)
	if err != nil {
...
func TestConfirmRedemption(t *testing.T) {
	...
	if st.Confs != confTxFinality {
		t.Fatalf("wrong confs for spent redemption: %d != %d", st.Confs, confTxFinality)
	}
