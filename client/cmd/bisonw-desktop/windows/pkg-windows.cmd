...
:MSI
echo Building MSI
dotnet build --property:Platform=x64 --configuration Release --output build\msi -noWarn:WIX1076 -p:DefineConstants="XmrEnabled=%XMR_ENABLED%" -p:CrossCompiled=%SKIP_BUILD% windows\windows-msi\BisonWallet_Installer.wixproj
